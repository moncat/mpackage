...
import com.cntend.beauty.base.interceptor.SessionInterceptor;
import com.co.example.config.ServletContextConfig;
...
@Configuration
//@EnableWebMvc
public class MyServletContextConfig extends ServletContextConfig {
