...
function fillData(data){
    ...
    $.each(data,function(k,v){
        ...
        html += '<td><a class="c-50a73f mlr-6" href="javascript:void(0)" onclick="showDetail(\''+ v.userId+'\')">查看</a><a class="c-50a73f mlr-6" href="javascript:void(0)" onclick="edit(\''+ v.userId+'\')">修改</a><a class="c-50a73f mlr-6" href="javascript:void(0)" onclick="del(\''+ v.userId+'\')">删除</a></td>';
        html +='</tr>' ;
