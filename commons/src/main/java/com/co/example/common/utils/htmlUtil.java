...
public class htmlUtil {
	...
	public static String getPage(String url) throws Exception {
		...
		HtmlTextInput txt = (HtmlTextInput) page.getElementById("searchtext");
		HtmlAnchor btn = (HtmlAnchor) page.getElementById("searchInfo");
		txt.setTextContent("唯恩诗");
		Page page2 = btn.click();
		System.out.println("***1***" + page2.getWebResponse().getContentAsString());
		System.out.println(page2.toString());
		webClient.close();

		// HtmlTextInput elementById1 =
		// (HtmlTextInput)page.getElementById("s1-0[0]-0[0]-account");
		// HtmlPasswordInput elementById2 =
		// (HtmlPasswordInput)page.getElementById("s1-0[0]-0[0]-password");
		// elementById1.setValueAttribute("888");
		// elementById2.setValueAttribute("*");
		// List<Object> newLinks = page.getByXPath ("//a[@class='btn btn-primary
		// btn-block btn-lg']");
		...
		// Page page1 =
		// page.executeJavaScript("$('.btn.btn-primary.btn-block.btn-lg').eq(0).click()").getNewPage();
		...
		// Thread.sleep(5000);
		// HtmlPage page2 =
		// webClient.getPage("https://www.qixin.com/company/1b9df7af-e7b3-4d45-93ce-8acf02534adb");
	...
	public static void main(String[] args) throws Exception {
		getPage("http://125.35.6.80:8181/ftban/fw.jsp");
