...
public class JSR310Test {
	public static void main(String[] args) throws InterruptedException {
      ...
      //使用默认时区时钟瞬时时间创建 Clock.systemDefaultZone() -->即相对于 ZoneId.systemDefault()默认时区  
        ...
        ZonedDateTime now22= ZonedDateTime.now(ZoneId.of("Europe/Paris"));
        System.out.println(now22);
      ...
      //表示两个瞬时时间的时间段  
        Duration d13 = Duration.between(Instant.ofEpochMilli(System.currentTimeMillis() - 12323123), Instant.now());  
        //得到相应的时差  
        System.out.println(d13.toDays());  
        System.out.println(d13.toHours());  
        System.out.println(d13.toMinutes());  
        System.out.println(d13.toMillis());  
        System.out.println(d13.toNanos());  
          
        //1天时差 类似的还有如ofHours()  
        Duration d23 = Duration.ofDays(1);  
        System.out.println(d23.toDays());  
