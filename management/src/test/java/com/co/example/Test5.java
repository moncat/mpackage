...
public class Test5 {
	...
	public static void setTest() {
		HashSet<TBrBrand> newHashSet = Sets.newHashSet();
		TBrBrand tBrBrand = new TBrBrand();
		tBrBrand.setId(1l);
		newHashSet.add(tBrBrand);
	...
	public static void convert(String storeType1, String stroe1FileName, String store1Passwd, String store1KeyAlias,
			String store1KeyPasswd, String store1CertChainAlias

			, String storeType2, String store2FileName, String store2Passwd, String store2KeyAlias,
		...
		try {
			...
			keystore2.setKeyEntry(store2KeyAlias, priKey, store2KeyPasswd.toCharArray(),
					keyStore1.getCertificateChain(store1CertChainAlias));
