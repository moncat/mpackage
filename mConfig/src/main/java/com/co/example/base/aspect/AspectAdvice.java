...
public class AspectAdvice {
	...
	@Pointcut("execution(public * com.co.example.controller..*.*(..))")
...
//    @AfterReturning( pointcut = "executeController()",returning="resultMap") 
//    public void doReturnAdvice(JoinPoint joinpoint,Object resultMap) throws Throwable { 
//    	String jsonString = JSON.toJSONString(resultMap);
//    	log.info("@AfterReturning="+jsonString);
//    }
